<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_disable_user.aspx.cs" Inherits="colunista_admin_adm_disable_user" %>
...
<link href="css/estilo.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="js/Controller/DeletarColunista.js"></script>
</head>
...
<div id="titulo" title="Painel de Controle">
  ...
  <div id="painel_de_controle">
  	Painel Administrativo do Módulo | Desativar Colunistas
  </div>
</div>
...
<!--formulario de publicacao -->
    <div id="publicar">
        ...
        <label>Desativar usuário Colunista:<br /></label>

        <label> </label><input type="text" id="Colunistas" size="60" class="k-textbox" /><br /><br />
         <input type="button" id="Enviar" class="k-button" data-bind="events: {click: Salvar}" value="Desativar Colunista"  /> 
        <br />
