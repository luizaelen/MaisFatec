...
<link href="../css/estilo_lista_postagem.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="../js/Controller/DeletarPostagem.js"></script>
</head>
...
<div id="titulo" title="Painel de Controle">
  ...
  <div id="painel_de_controle">
  	PAINEL DE CONTROLE - Excluir Publicação
  </div>
</div>
...
<!--topo -->
    ...
    <div id="RetornarMenu" class="opcao">
     ...
     <!--fim da área de menu -->
    <div id="conteudo">  
          <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Selecione uma publicação para excluir:</b></label>
    ...
    <script type="text/x-kendo-tmpl" id="templateTema">
                    <div class="postagem">
                   <span id="conteudoPostagem"><label><img src="../images/del_publicacao_small.png" /> #:Titulo# </label> </span>
                    </div>
